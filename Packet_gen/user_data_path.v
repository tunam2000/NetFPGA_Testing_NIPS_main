...
module user_data_path
  #(parameter DATA_WIDTH = 64,
    ...
    parameter NUM_OUTPUT_QUEUES = 4,//8,
    parameter NUM_INPUT_QUEUES = 4,//8,
...
*****/
   ...
   wire [UDP_REG_SRC_WIDTH-1:0]     rate_limiter_in_reg_src[NUM_OUTPUT_QUEUES+1-1:0];
	...
	wire [CTRL_WIDTH-1:0]            out_ctrl_a;
   wire [DATA_WIDTH-1:0]            out_data_a;
   wire                             out_wr_a;
   wire                             out_rdy_a;
	wire                             out_reply_a;
	
	wire [CTRL_WIDTH-1:0]            out_ctrl_b;
   ...
   wire                             out_rdy_c;
	...
	wire [CTRL_WIDTH-1:0]            out_ctrl_d;
   wire [DATA_WIDTH-1:0]            out_data_d;
   wire                             out_wr_d;
   wire                             out_rdy_d;
	wire                             out_reply_d;
	
	wire                             syn_gen_in_reg_req;
   wire                             syn_gen_in_reg_ack;
   wire                             syn_gen_in_reg_rd_wr_L;
   wire [`UDP_REG_ADDR_WIDTH-1:0]   syn_gen_in_reg_addr;
   wire [`CPCI_NF2_DATA_WIDTH-1:0]  syn_gen_in_reg_data;
   wire [UDP_REG_SRC_WIDTH-1:0]     syn_gen_in_reg_src;
...
//    .out_rdy_11                           (op_sel_in_rdy[11]),
    ...
    .reg_req_out                          (syn_gen_in_reg_req),
    .reg_ack_out                          (syn_gen_in_reg_ack),
    .reg_rd_wr_L_out                      (syn_gen_in_reg_rd_wr_L),
    .reg_addr_out                         (syn_gen_in_reg_addr),
    .reg_data_out                         (syn_gen_in_reg_data),
    .reg_src_out                          (syn_gen_in_reg_src),
	...
	TCP_SYN_GEN TCP_SYN_GEN(
	
		.out_data_0                           (out_data_c),
      .out_ctrl_0                           (out_ctrl_c),
      .out_wr_0                             (out_wr_c),
      .out_rdy_0                            (out_rdy_c),
		.out_reply_0									(out_reply_c),
		
		.out_data_1                           (out_data_d),
      .out_ctrl_1                           (out_ctrl_d),
      .out_wr_1                             (out_wr_d),
      .out_rdy_1                            (out_rdy_d),
		.out_reply_1									(out_reply_d),

      // --- Register interface
      .reg_req_in                         (syn_gen_in_reg_req),
      .reg_ack_in                         (syn_gen_in_reg_ack),
      .reg_rd_wr_L_in                     (syn_gen_in_reg_rd_wr_L),
      .reg_addr_in                        (syn_gen_in_reg_addr),
      .reg_data_in                        (syn_gen_in_reg_data),
      .reg_src_in                         (syn_gen_in_reg_src),
   ...
   #(
      ...
      .in_wr_3                            (op_sel_in_wr[3]),
		...
		.in_data_a                          (out_data_a),
      .in_ctrl_a                          (out_ctrl_a),
      .in_rdy_a                           (out_rdy_a),
      .in_wr_a                            (out_wr_a),
		.in_reply_a									(out_reply_a),
		
		.in_data_b                          (out_data_b),
      .in_ctrl_b                          (out_ctrl_b),
      .in_rdy_b                           (out_rdy_b),
      .in_wr_b                            (out_wr_b),
		.in_reply_b									(out_reply_b),
		
		.in_data_c                          (out_data_c),
      .in_ctrl_c                          (out_ctrl_c),
      .in_rdy_c                           (out_rdy_c),
      .in_wr_c                            (out_wr_c),
		.in_reply_c									(out_reply_c),
		
		.in_data_d                          (out_data_d),
      .in_ctrl_d                          (out_ctrl_d),
      .in_rdy_d                           (out_rdy_d),
      .in_wr_d                            (out_wr_d),
		.in_reply_d									(out_reply_d),
