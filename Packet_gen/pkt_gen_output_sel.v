...
module pkt_gen_output_sel
   ...
   (
      ...
      input  [CTRL_WIDTH-1:0]             in_ctrl_b,
      output                              in_rdy_b,
      input                               in_wr_b,
		input											in_reply_b,
		
		input  [DATA_WIDTH-1:0]             in_data_c,
      input  [CTRL_WIDTH-1:0]             in_ctrl_c,
      output                              in_rdy_c,
      input                               in_wr_c,
		input											in_reply_c,
		
		input  [DATA_WIDTH-1:0]             in_data_d,
      input  [CTRL_WIDTH-1:0]             in_ctrl_d,
      output                              in_rdy_d,
      input                               in_wr_d,
		input											in_reply_d,
...
port_mux_new
   #(
      ...
      // --- Register interface
      .select                               (enable[1]),
		.in_reply_2										(in_reply_b),
		.in_reply_3										(in_reply_d),
      // --- Misc
      .clk                                  (clk),
      .reset                                (reset)
   );
